/* ============================================================
 * 运行配置：Supabase 云端同步凭证
 * 把你在 Supabase 项目 Settings → API 里拿到的两项填进来即可。
 * 留空则应用保持「纯本地模式」，不影响现有功能。
 * ============================================================ */
window.APP_CONFIG = {
  // 反代入口（腾讯云 SCF Web 函数，香港·公网）→ 转发到 Supabase 源站
  SUPABASE_URL: 'https://1459233211-6ybko6xjw1.ap-hongkong.tencentscf.com',
