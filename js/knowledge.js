...
(function (global) {
  ...
  var TAX_KB = [
    ...
    { cat: '税费测算专题', items: [
      { t: '印花税税目与税率', b: '印花税按应税凭证类型从价计征（2022.7.1《印花税法》施行）：借款合同 <b>0.005%</b>、买卖/建设工程/技术合同 <b>0.03%</b>、承揽/运输合同/产权转移书据（股权、不动产）<b>0.05%</b>、租赁/仓储/保管/财产保险合同/证券交易 <b>0.1%</b>、营业账簿（实收资本+资本公积）<b>0.025%</b>。应纳税额 = 计税金额 × 税率。工作台「知识工具 → 💰 印花税计算」可逐项累加。' },
      { t: '残疾人就业保障金（残保金）', b: '保障金 =（上年职工人数 × <b>1.5%</b> − 上年安排残疾人数）× 上年职工年平均工资 × 分档系数。分档减缴（2023–2027）：安排比例 ≥1%(含) 且 <1.5% → ×50%；<1% → ×90%；≥1.5% 或 在职职工 ≤30 人 → <b>免征</b>；年平均工资超社平 2 倍按上限计征。工作台「知识工具 → ♿ 残保金测算」可一键测算。' },
      { t: '个人所得税（累计预扣法）', b: '工资薪金按月累计预扣：累计应纳税所得额 = 累计收入 − 累计减除费用(5000×月数) − 累计专项扣除 − 专项附加扣除。本月预扣 =（累计应纳税所得额 × 预扣率 − 速算扣除数）− 累计已预扣。因累计跨档，<b>每月工资相同时本月预扣也会在年中跳升</b>。工作台「知识工具 → 🧾 个税累计预扣表」可出全年逐月表。' }
    ]},
    { cat: '账务基础', items: [
