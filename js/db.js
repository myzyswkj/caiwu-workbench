...
(function (global) {
  ...
  // 按账本隔离的键
  var PERLEDGER_KEYS = ['internal', 'internal_budget', 'internal_cats', 'internal_openings', 'internal_accounts', 'tax_vouchers', 'tax_journals', 'tax_statements', 'contacts', 'tax_openings', 'tax_assets', 'invoices', 'contracts', 'stock', 'tax_filings', 'tax_calendar_custom', 'salary_employees', 'salary_records', 'project_qty'];
