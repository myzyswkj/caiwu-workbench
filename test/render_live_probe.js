...
var subtable = {
  title: '按账户（收支维度）',
  note: '注：区间期初 = 筛选开始前的账户余额；区间期末余额 = 区间期初 + 收入 − 支出 + 互转 + 股本净变动。',
...
[1, 1.35, 1.8, 2.4].forEach(function (fs) {
  var cfg = {
    ...
    kpis: [{ label: '笔数', value: '2' }, { label: '收入合计', value: '¥1,000.00', cls: 'income' }, { label: '支出合计', value: '¥200.00', cls: 'expense' }, { label: '区间收支合计', value: '¥800.00' }],
